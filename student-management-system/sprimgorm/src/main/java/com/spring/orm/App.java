...
//        System.out.println("done " + r);
        ...
        while(go) {
        	...
        	System.out.println("PRESS 5 for updte student");
        	...
        	try {
        		...
        		case 5:
        			...
        			System.out.println("Enter user id: ");
        			int uIdUpdate = Integer.parseInt(br.readLine());
        			
        			System.out.println("Enter user name: ");
        			String uNameUpdate = br.readLine();
        			...
        			sUp.setStudentId(uIdUpdate);
        			sUp.setStudentName(uNameUpdate);
        			sUp.setStudentCity(cityUpdate);
        			
        			studentDao.updateStudent(sUp);
        			break;
        		case 6:
        			//exit
        			go = false;
